...
methyl_df$Sample_ID <- colnames(methylation) [-c(1, 2, 3, 4)] 
...
# Save cleaned_gene_exp as a CSV file for HPC analysis 
...
hypermethylated_genes_p <- top_20_hypermethylated_p$NAME  # Ensure names are correct
