...
copy_number <- read.delim("C:/Users/lauri/OneDrive - Queen's University Belfast/Master's/Dissertation/Dissertation/Dataset/Lung/lusc_tcga_pan_can_atlas_2018/data_cna.txt")
...
# Example of loading sample clusters
...
merged_results <- merge(significant_df, protein, by.x = "Protein", by.y = "Composite.Element.REF")
...
# Extract protein names from the 'Protein' column
